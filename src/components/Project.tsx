...
const Project: FC<IProject> = (props) => {
  return (
    <Box sx={{ display: 'flex', gap: 4, pb: 2 }}>
      <Box sx={{ flexShrink: 0, width: '250px', height: '130px', border: 2, borderColor: 'secondary.main', borderRadius: '10px', position: 'relative', overflow: 'hidden'}}>
        <Image src='/project.png' alt='project image' fill />
      </Box>
      <Box sx={{ color: 'common.white' }}>
        <Typography variant='h6' component='h4'>Project Title</Typography>
        <Typography>
